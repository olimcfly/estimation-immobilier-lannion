...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        h1 { font-size: 1.5rem; margin-bottom: 1.5rem; color: #1B6B8A; }
        ...
        th { background: #1B6B8A; color: #fff; font-weight: 600; font-size: .85rem; text-transform: uppercase; letter-spacing: .03em; }
        td { font-size: .95rem; }
        ...
        .env-key { font-weight: 600; color: #1B6B8A; }
