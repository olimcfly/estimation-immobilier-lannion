 ...
 *   ADMIN_EMAIL - Admin email (default: contact@estimation-immobilier-lannion.fr)
 */
...
$email = $argv[1] ?? $_ENV['ADMIN_EMAIL'] ?? 'contact@estimation-immobilier-lannion.fr';
...
echo "\nSetup terminé !\n";
echo "Connectez-vous sur : https://estimation-immobilier-lannion.fr/admin/login\n";
