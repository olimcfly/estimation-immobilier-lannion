...
<head>
  ...
  <title><?= isset($page_title) ? htmlspecialchars($page_title, ENT_QUOTES, 'UTF-8') : 'Admin - Estimation Immobilier Lannion' ?></title>
  ...
  <style>
    :root {
      ...
      --admin-bg: #f4f1ed;
      --admin-sidebar-bg: #1a2030;
      --admin-sidebar-text: #c8c0b8;
      --admin-sidebar-hover: rgba(255,255,255,0.08);
      --admin-sidebar-active: rgba(27, 107, 138, 0.4);
      --admin-primary: #1B6B8A;
      --admin-accent: #D4836B;
    }
    ...
    * { box-sizing: border-box; }
    ...
    .admin-sidebar-brand-icon {
      ...
      background: linear-gradient(135deg, var(--admin-primary), #145A73);
      border-radius: 8px;
      color: #fff;
      font-size: 1rem;
      flex-shrink: 0;
