  ...
  <div class="container">
    ...
    <div class="footer-grid">
      ...
      <div class="footer-column">
        ...
        <ul class="footer-links">
          ...
          <li><a href="/quartiers">Quartiers de Lannion</a></li>
        ...
        <ul class="footer-contact">
          ...
          <li>
            <a href="mailto:contact@estimation-immobilier-lannion.fr">
              ...
              <span>contact@estimation-immobilier-lannion.fr</span>
            </a>
          </li>
        </ul>
      </div>
    ...
    <div class="footer-bottom">
      <div class="footer-bottom-left">
        <p>&copy; 2026 Estimation Immobilier Lannion &mdash; SAS OCDM Agency. Tous droits réservés.</p>
      </div>
