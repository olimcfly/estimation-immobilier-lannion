...
<head>
  ...
  <meta property="og:title" content="<?= isset($page_title) ? htmlspecialchars($page_title, ENT_QUOTES, 'UTF-8') : 'Estimation Immobilier Lannion' ?>">
  <meta property="og:description" content="<?= htmlspecialchars((string) ($meta_description ?? 'Obtenez votre avis de valeur immobilier gratuit à Lannion. Résultat en 60 secondes.'), ENT_QUOTES, 'UTF-8') ?>">
  <meta property="og:url" content="<?= e($canonicalUrl) ?>">
  <meta property="og:locale" content="fr_FR">
  <meta property="og:site_name" content="Estimation Immobilier Lannion">
  <meta property="og:image" content="https://estimation-immobilier-lannion.fr/assets/images/og-estimation-lannion.png">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">

  <!-- Twitter Card -->
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="<?= isset($page_title) ? htmlspecialchars($page_title, ENT_QUOTES, 'UTF-8') : 'Estimation Immobilier Lannion' ?>">
  <meta name="twitter:description" content="<?= htmlspecialchars((string) ($meta_description ?? 'Avis de valeur immobilier gratuit à Lannion. Résultat en 60 secondes.'), ENT_QUOTES, 'UTF-8') ?>">
  <meta name="twitter:image" content="https://estimation-immobilier-lannion.fr/assets/images/og-estimation-lannion.png">
...
<header class="site-header">
  <div class="container nav-wrapper">
    <a href="/" class="brand">Estimation Immobilier <span>Lannion</span></a>
    ...
    <nav class="top-nav" aria-label="Navigation principale">
      ...
      <div class="nav-item has-dropdown">
        ...
        <ul class="dropdown-menu" aria-label="Sous-menu ressources">
          ...
          <li><a href="/quartiers">Quartiers Lannion</a></li>
