<?php
/**
 * Landing Page Google Ads — Mot-clé : "estimation immobilière lannion"
 *
...
<section class="lp-hero">
  <div class="lp-container lp-hero-grid">
    ...
    <div class="lp-hero-content">
      ...
      <h1>Estimation Immobilière <span class="lp-highlight">Lannion</span> — Gratuite en 60 secondes</h1>
      ...
      <div class="lp-social-proof-mini">
        ...
        <span>4.8/5 — Plus de <strong>2 400 estimations</strong> réalisées à Lannion</span>
      </div>
    </div>
    ...
    <div class="lp-form-card">
      ...
      <form action="/lp/submit" method="post" class="lp-form" id="lp-form">
        <input type="hidden" name="landing_slug" value="<?= e((string) ($landing_slug ?? 'estimation-lannion')) ?>">
...
<section class="lp-section">
  <div class="lp-container">
    <div class="lp-section-heading">
      ...
      <h2>L'estimation immobilière la plus fiable de <span class="lp-highlight">Lannion</span></h2>
    </div>
...
<section class="lp-section">
  <div class="lp-container">
    <div class="lp-section-heading">
      ...
      <h2>Ce que disent nos clients à Lannion</h2>
    </div>
...
<section class="lp-section lp-section-alt">
  <div class="lp-container">
    <div class="lp-section-heading">
      ...
      <h2>Tout savoir sur l'estimation immobilière à Lannion</h2>
    </div>
    ...
    <div class="lp-faq">
      ...
      <details class="lp-faq-item">
        ...
        <p>Notre algorithme analyse les transactions immobilières récentes à Lannion, les prix au m² par quartier, le type de bien et sa surface pour vous fournir une fourchette de prix réaliste.</p>
      </details>
      <details class="lp-faq-item">
...
<section class="lp-section lp-cta-section">
  <div class="lp-container lp-cta-content">
    ...
    <p class="lp-cta-sub">Plus de 2 400 estimations réalisées à Lannion</p>
  </div>
</section>
