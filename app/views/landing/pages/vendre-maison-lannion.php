<?php
/**
 * Landing Page Google Ads — Mot-clé : "vendre maison lannion"
 */
...
<section class="lp-hero">
  <div class="lp-container lp-hero-grid">
    ...
    <div class="lp-hero-content">
      <p class="lp-eyebrow">
        <i class="fas fa-home"></i> Vente immobilière à Lannion
      </p>

      <h1>Vendez votre maison à <span class="lp-highlight">Lannion</span> au meilleur prix</h1>

      <p class="lp-lead">
        Vous envisagez de <strong>vendre votre maison à Lannion</strong> ?
      ...
      <ul class="lp-trust-list">
        ...
        <li><i class="fas fa-map-marked-alt"></i> <strong>Connaissance locale</strong> — Lannion et Côtes-d'Armor</li>
      </ul>
    ...
    <div class="lp-form-card">
      <div class="lp-form-header">
        ...
        <p>Recevez gratuitement la valeur de votre maison à Lannion.</p>
      </div>
      ...
      <form action="/lp/submit" method="post" class="lp-form" id="lp-form">
        <input type="hidden" name="landing_slug" value="<?= e((string) ($landing_slug ?? 'vendre-maison-lannion')) ?>">
...
<section class="lp-section">
  <div class="lp-container">
    <div class="lp-section-heading">
      ...
      <h2>Ils ont vendu leur maison à Lannion avec nous</h2>
    </div>
  ...
  <div class="lp-container">
    ...
    <div class="lp-faq">
      ...
      <details class="lp-faq-item">
        ...
        <p>En moyenne, une maison correctement estimée se vend entre 1 et 3 mois à Lannion. Un prix juste dès le départ est la clé pour une vente rapide.</p>
      </details>
      <details class="lp-faq-item">
