<?php
/**
 * Landing Page Google Ads — Mot-clé : "avis de valeur gratuit lannion"
 */
...
<section class="lp-hero">
  <div class="lp-container lp-hero-grid">
    ...
    <div class="lp-hero-content">
      ...
      <h1>Avis de Valeur <span class="lp-highlight">Gratuit</span> pour votre bien à Lannion</h1>

      <p class="lp-lead">
        Recevez un <strong>avis de valeur gratuit et sans engagement</strong> pour votre appartement ou maison à Lannion.
