...
<style>
  ...
  .tpl-estimation {
    ...
    background: linear-gradient(135deg, #1B6B8A 0%, #0E4A5E 60%, #0A2A35 100%);
    display: flex; flex-direction: column; justify-content: center; align-items: center;
    color: #fff; text-align: center; padding: 80px;
  }
  .tpl-estimation .badge-top {
    background: rgba(212, 131, 107, 0.2); border: 1px solid #D4836B;
    padding: 10px 28px; border-radius: 30px; font-size: 22px; font-weight: 600;
    color: #D4836B; margin-bottom: 40px; letter-spacing: 0.05em;
  }
  ...
  .tpl-estimation .divider {
    width: 80px; height: 3px; background: #D4836B; margin-bottom: 50px;
  }
  ...
  .tpl-conseil .tip-number {
    font-size: 72px; font-weight: 700; color: #D4836B; margin-bottom: 20px; line-height: 1;
  }
  .tpl-conseil .tip-title {
    font-size: 48px; font-weight: 700; color: #1a2030; line-height: 1.2; margin-bottom: 30px;
  }
  .tpl-conseil .tip-text {
    font-size: 26px; color: #5f6d7e; line-height: 1.5;
  }
  .tpl-conseil .footer-bar {
    padding: 30px 60px; border-top: 2px solid #dde4ec;
    display: flex; align-items: center; justify-content: space-between;
  }
  .tpl-conseil .footer-bar .url { font-size: 18px; color: #1B6B8A; font-weight: 600; }
  .tpl-conseil .footer-bar .cta { font-size: 18px; color: #5f6d7e; }
  ...
  .tpl-stat .stat-value {
    font-size: 120px; font-weight: 700; color: #D4836B; line-height: 1; margin-bottom: 20px;
  }
  .tpl-stat .stat-unit {
    font-size: 36px; color: #D4836B; font-weight: 500; margin-bottom: 50px;
  }
  .tpl-stat .stat-desc {
  ...
  .tpl-story {
    ...
    background: linear-gradient(180deg, #1B6B8A 0%, #0E4A5E 40%, #0A2A35 100%);
  ...
  .tpl-story .story-cta {
    display: inline-block; background: #D4836B; color: #0A2A35; padding: 20px 50px;
  ...
  .tpl-paysage {
    ...
    background: linear-gradient(135deg, #1B6B8A 0%, #0E4A5E 50%, #0D3A48 100%);
  ...
  .tpl-paysage .tag-line {
    font-size: 16px; color: #D4836B; text-transform: uppercase;
  ...
  .tpl-paysage .right-big {
    font-size: 72px; font-weight: 700; color: #D4836B; line-height: 1;
  }
  ...
  var templates = {
    estimation: {
      fields: [
        ...
        { id: 'quartier', label: 'Quartier', type: 'select', options: ['Lannion Centre', <?php foreach ($quartiers as $q): ?>'<?= $q ?>',<?php endforeach; ?>], value: 'Lannion Centre' },
        { id: 'badge', label: 'Badge', type: 'text', value: 'ESTIMATION GRATUITE' },
        { id: 'brand', label: 'Marque', type: 'text', value: 'estimation-immobilier-lannion.fr' },
        { id: 'bg1', label: 'Couleur d\u00e9but', type: 'color', value: '#1B6B8A' },
        { id: 'bg2', label: 'Couleur fin', type: 'color', value: '#0A2A35' },
      ],
      render: function(v) {
        return '<div class="social-card tpl-estimation" style="background:linear-gradient(135deg,' + v.bg1 + ' 0%,' + v.bg2 + ' 100%);">' +
          ...
          '<div class="city">Lannion &mdash; Bretagne</div>' +
    ...
    conseil: {
      fields: [
        ...
        { id: 'brand', label: 'Marque', type: 'text', value: 'Estimation Immobilier Lannion' },
        { id: 'url', label: 'URL', type: 'text', value: 'estimation-immobilier-lannion.fr' },
    ...
    stat: {
      fields: [
        { id: 'label', label: 'Label', type: 'text', value: 'MARCH\u00c9 IMMOBILIER LANNION' },
        { id: 'value', label: 'Chiffre', type: 'text', value: '+12%' },
        { id: 'unit', label: 'Unit\u00e9', type: 'text', value: 'en 2 ans' },
        { id: 'desc', label: 'Description', type: 'textarea', value: 'Les prix de l\u2019immobilier \u00e0 Lannion ont progress\u00e9 de 12% sur les deux derni\u00e8res ann\u00e9es.' },
        { id: 'brand', label: 'Marque', type: 'text', value: 'estimation-immobilier-lannion.fr' },
    ...
    story: {
      fields: [
        ...
        { id: 'title', label: 'Titre', type: 'text', value: 'Combien vaut votre bien \u00e0 Lannion ?' },
    ...
    paysage: {
      fields: [
        ...
        { id: 'title', label: 'Titre', type: 'text', value: 'Estimez votre bien immobilier \u00e0 Lannion' },
        ...
        { id: 'brand', label: 'Marque', type: 'text', value: 'estimation-immobilier-lannion.fr' },
        { id: 'bg1', label: 'Couleur d\u00e9but', type: 'color', value: '#1B6B8A' },
        { id: 'bg2', label: 'Couleur fin', type: 'color', value: '#0D3A48' },
      ],
      render: function(v) {
