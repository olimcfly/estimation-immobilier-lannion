  ...
  <form method="POST" action="/admin/partenaires/save">
    ...
    <div class="form-grid">
      ...
      <div class="form-group">
        ...
        <input type="text" id="zone_geographique" name="zone_geographique" value="<?= htmlspecialchars((string)($p['zone_geographique'] ?? ''), ENT_QUOTES, 'UTF-8') ?>" placeholder="Ex: Lannion Centre, Rive Droite...">
      </div>
