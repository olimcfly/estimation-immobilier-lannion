<?php $page_title = 'À Propos - Estimation Immobilière Lannion | Notre Histoire & Équipe'; ?>
  ...
  <div class="container">
    <div class="about-grid">
      ...
      <article class="card about-card">
        ...
        <h2>Notre Mission</h2>
        <p>
          Rendre l'estimation immobilière accessible, rapide et fiable pour tous les vendeurs de la région Lannion-Métropole. 
  ...
  <div class="container">
    ...
    <div class="stats-grid">
      ...
      <div class="card stat-box">
        ...
        <p class="stat-desc">Dans la région Lannion depuis 2023</p>
      </div>
      ...
      <div class="card stat-box">
        ...
        <p class="stat-desc">Lannion intra-muros + banlieue</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="values-grid">
      ...
      <article class="card value-card">
        ...
        <p>
          Analyse basée sur 5000+ transactions réelles à Lannion et région. Marché temps réel, pas de statistiques obsolètes.
        </p>
      </article>
    ...
    <div class="process-timeline">
      ...
      <div class="timeline-item">
        ...
        <div class="timeline-content">
          ...
          <p>
            Notre moteur compare avec 5000+ biens similaires vendus récemment à Lannion et région.
          </p>
        </div>
      </div>
...
<section class="section section-alt">
  <div class="container">
    <div class="section-heading">
      ...
      <h2>Présents partout à Lannion et région</h2>
    </div>
  ...
  <div class="container">
    ...
    <div class="faq-grid">
      ...
      <article class="card faq-card">
        ...
        <p>
          Nous sommes une équipe d'experts immobiliers basée à Lannion. Notre mission : 
      ...
      <article class="card faq-card">
        ...
        <p>
          Notre algorithme analyse 5000+ transactions réelles à Lannion. Pas de théorie, 
      ...
      <article class="card faq-card">
        ...
        <p>
          Oui, Lannion intra-muros + banlieue proche. Extension progressive vers la Côtes-d'Armor. 
...
<section class="section">
  <div class="container">
    <div class="cta-final card">
      ...
      <h2>Faites confiance aux experts de Lannion</h2>
      <p class="lead">
