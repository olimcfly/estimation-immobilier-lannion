<?php $page_title = 'Estimation Immobilier Lannion | Avis de Valeur Gratuit'; ?>
<?php $meta_description = 'Obtenez une fourchette de prix indicative gratuite pour votre bien immobilier à Lannion en 60 secondes. 3 informations suffisent. 100% gratuit, sans engagement.'; ?>
...
<section class="hero">
  <div class="container hero-grid">
    ...
    <div>
      ...
      <h1>Estimez la valeur de votre bien immobilier à Lannion</h1>
    ...
    <aside class="hero-panel card" id="form-estimation">
      ...
      <div style="padding: 1.5rem;">
        <ul style="list-style: none; padding: 0; margin: 0 0 1.5rem;">
          ...
          <li style="margin-bottom: 1rem; display: flex; align-items: center; gap: 0.75rem;">
            <i class="fas fa-check-circle" style="color: var(--primary); font-size: 1.2rem;"></i>
            <span><strong>Données réelles</strong> — 5000+ transactions en Côtes-d'Armor</span>
          </li>
