<section class="section page-hero">
  <div class="container">
    <div class="page-hero-inner card">
      ...
      <p class="lead">Informations éditoriales et juridiques relatives au site Estimation Immobilier Lannion.</p>
    </div>
  </div>
</section>
...
<section class="section">
  <div class="container card" style="display: grid; gap: 1.25rem;">
    ...
    <h2>Contact</h2>
    <p>Email : <a href="mailto:contact@estimation-immobilier-lannion.fr">contact@estimation-immobilier-lannion.fr</a> — Téléphone : +33 5 56 00 00 00.</p>
  </div>
</section>
