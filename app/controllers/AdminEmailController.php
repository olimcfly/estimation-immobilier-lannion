...
final class AdminEmailController
{
    ...
    public function aiGenerate(): void
    {
        ...
        $prompts = [
            ...
            'signature' => "G&eacute;n&egrave;re une signature email professionnelle pour un agent immobilier &agrave; Lannion. Contexte: {$context}. Signature actuelle: {$currentValue}. Format texte simple avec retours &agrave; la ligne.",
        ];
