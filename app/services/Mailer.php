...
final class Mailer
{
    ...
    private static function attemptSend(string $to, string $subject, string $htmlBody, string &$errorOut): bool
    {
        ...
        try {
            ...
            $fromAddress = (string) Config::get('mail.from', 'no-reply@estimation-immobilier-lannion.fr');
            $fromName = (string) Config::get('mail.from_name', 'Estimation Immobilier Lannion');
            ...
            $mail->CharSet = 'UTF-8';
            $mail->XMailer = 'Estimation Immobilier Lannion';
