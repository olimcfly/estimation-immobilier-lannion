...
$hosts = [
    'mail1.o2switch.net',
    'mail.estimation-immobilier-lannion.fr',
    'estimation-immobilier-lannion.fr',
];
...
$mailFrom = $_ENV['MAIL_FROM_ADDRESS'] ?? $_ENV['MAIL_FROM'] ?? 'contact@estimation-immobilier-lannion.fr';
