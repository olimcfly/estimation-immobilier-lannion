...
final class ActualiteServiceTest extends TestCase
{
    ...
    {
        $result = $this->service->searchNews('prix immobilier Lannion 2026');

        $this->assertSame('prix immobilier Lannion 2026', $result['query']);
    ...
    {
        $ideas = [
            ['title' => 'Marché immobilier Lannion', 'summary' => 'Les prix évoluent', 'angle' => 'Analyse'],
        ];
    ...
    public function testCronScriptSlugify(): void
    {
        ...
        $this->assertSame('estimation-immobilière-lannion', cronSlugify('Estimation Immobilière Lannion'));
